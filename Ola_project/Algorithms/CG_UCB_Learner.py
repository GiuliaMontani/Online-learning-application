...
class CG_UCB(Learner):
    ...
    def pull_arm(self):
        ...
        for split_1 in range(2):
            for split_2 in range(2):
                ...
                for i in range(5):
                    ...
                    upper_conf_per_type[split_1][split_2][i] = self.expected_rewards_per_type[split_1][split_2][i] + self.confidence_per_type[split_1][split_2][i] * self.make_comparable_per_type[split_1][split_2][i]
                    ...
                    idx[split_1][split_2][i] = np.random.choice(np.argwhere(upper_conf_per_type[split_1][split_2][i] == upper_conf_per_type[split_1][split_2][i].max()).reshape(-1))  # 2x slower
    ...
    def update(self, pulled_arm, reward):
        ...
        for split_1 in range(2):
            for split_2 in range(2):
                for i in range(5):
                    self.counter_per_arm_per_type[split_1][split_2][i][int(pulled_arm[split_1][split_2][i])] += 1
                    self.expected_rewards_per_type[split_1][split_2][i][int(pulled_arm[split_1][split_2][i])] = (self.expected_rewards_per_type[split_1][split_2][i][int(pulled_arm[split_1][split_2][i])] * (
                            self.counter_per_arm_per_type[split_1][split_2][i][int(pulled_arm[split_1][split_2][i])] - 1) + reward[i]) / self.counter_per_arm_per_type[split_1][split_2][i][
                                                                       int(pulled_arm[split_1][split_2][i])]
                ...
                self.update_observations(pulled_arm[split_1][split_2], reward)
