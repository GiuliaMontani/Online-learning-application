...
#homogenous user class with fixed graph weights (for the first steps)     
class FixedUsers(User):
    def __init__(self, primary):
        User.__init__(self, primary)
        self.reservation_price = [10,23,35,41,54] + np.random.normal(0, scale=2, size=5) # average reservation price
